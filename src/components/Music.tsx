  ...
  const albums = [
    {
      ...
      year: "2025",
      coverUrl:
        "https://i.scdn.co/image/ab67616d00001e021931e35d2d5b0aa08a2d70c4",
      streamUrl:
        "https://open.spotify.com/album/02bJgSv54PPaIH3RkjQHCQ?uid=toptrack7fk6OByVeNfjulxOAtFSN6&uri=spotify%3Atrack%3A7fk6OByVeNfjulxOAtFSN6",
    },
    {
      id: 2,
      title: "Lil Шмаль",
      year: "2025",
      coverUrl:
        "https://i.scdn.co/image/ab67616d00001e02350ef02a7863cebc14439588",
    ...
    },
    {
      ...
      year: "2025",
      coverUrl:
        "https://i.scdn.co/image/ab67616d00001e026ea234aec2cdebd3d8e6a5c9",
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600 transform -rotate-2 inline-block">
            Latest
          </span>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start relative">
          ...
          >
            <h3 className="text-xl font-semibold mb-8 text-gray-300 transform -rotate-2">
              Albums & EPs
            </h3>
          ...
          >
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-lg p-4 transform hover:rotate-1 transition-transform duration-300">
              <ul className="divide-y divide-gray-700/50">
                {topTracks.map((track, index) => (
                  ...
                  >
                    <span className="text-gray-500 font-medium mr-4 w-5 text-center">
                      {index + 1}
                    </span>
            ...
            <div className="mt-8 relative">
              <h3 className="text-xl font-semibold mb-4 text-gray-300 transform -rotate-2">
                Listen On
              </h3>
